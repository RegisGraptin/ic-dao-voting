...
import { idlFactory } from './backend-icp.did.js';
export { idlFactory } from './backend-icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BACKEND_ICP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./backend-icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the backend-icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./backend-icp.did.js")._SERVICE>}
 */
export const backend_icp = createActor(canisterId);
